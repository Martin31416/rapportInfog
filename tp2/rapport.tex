...
\TitreRapport{Application graphique Paint++}                       % Titre du rapport
\Destinataire{Philippe Voyer}        
% Nom(s) du destinataire
\NumeroEquipe{XX}                                     % Numero de l'equipe
\NomEquipe{Équipe 23}                                    % Nom de l'equipe
