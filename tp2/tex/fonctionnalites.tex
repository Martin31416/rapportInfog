...
Il est possible de sélectionner plusieurs entitées visuelles dans l'application Paint3D+. Un coup selectionnées, ces entitées peuvent changer leurs attributs en commun ou être rassemblées pour créer un nouvel object appelé Obj2DCollection. Cette collection emmagasine les structures selectionnées dans un nouveau vecteur.
